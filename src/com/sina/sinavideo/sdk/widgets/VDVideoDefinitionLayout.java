 ...
 * 
 */
public class VDVideoDefinitionLayout extends LinearLayout implements VDBaseWidget, OnVMSResolutionListener {
    ...
    public void onVMSResolutionContainerVisible(boolean isVisible) {
        ...
        if (controller == null)
            return;
        HashMap<String, String> vmsResolutionInfo = controller.getCurrVMSResolutionInfo();
    ...
    private void addItems(Set<String> keys) {
        ...
        for (Iterator<String> iterator = desc.keySet().iterator(); iterator.hasNext();) {
                ...
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        VDVideoViewController controller = VDVideoViewController
                                .getInstance(VDVideoDefinitionLayout.this.getContext());
                        if (controller == null) {
                            return;
                        }
