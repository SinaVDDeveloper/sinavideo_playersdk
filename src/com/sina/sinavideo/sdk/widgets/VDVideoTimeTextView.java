...
public class VDVideoTimeTextView extends TextView implements VDBaseWidget,
    ...
    public VDVideoTimeTextView(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArr = context.obtainStyledAttributes(attrs, new int[]{android.R.attr.textColor});
        ...
        mTimeFormat = a.getInteger(R.styleable.TimeTextView_TimeFormat, TIME_FORMAT_PROGRESSDURAION);
        a.recycle();
    }
    ...
    public void onProgressUpdate(long current, long duration) {
        ...
        switch (mTimeFormat) {
            case TIME_FORMAT_PROGRESSDURAION :
                setText(VDUtility.generatePlayTime(current) + "/" + VDUtility.generatePlayTime(duration));
                break;
