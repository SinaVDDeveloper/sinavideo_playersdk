 ...
 * @author sunxiao
 */
public final class VDVideoDecodingButton extends ImageButton implements
		VDBaseWidget {
	...
	private class VDVideoDecodingDialogAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			if (convertView == null) {
				...
				viewHolder.rb1 = (RadioButton) convertView
			...
			boolean isFFMpeg = VDSharedPreferencesUtil
					.isDecodingTypeFFMpeg(mContext);
			...
			convertView.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if ((VDSharedPreferencesUtil.isDecodingTypeFFMpeg(mContext) && position == 1)
							|| (!VDSharedPreferencesUtil
									.isDecodingTypeFFMpeg(mContext) && position == 2)) {
						// 相等，不设置，直接退出
						return;
					}
	...
	public VDVideoDecodingButton(Context context, AttributeSet attrs) {
		...
		TypedArray typedArr = context.obtainStyledAttributes(attrs,
				R.styleable.VDVideoDecodingButton);
		if (typedArr != null) {
			...
			public void onClick(View v) {
				...
				if (!supportHard) {
					Toast.makeText(getContext(),
							R.string.sorry_cannot_switch_player, 0).show();
					controller.notifyHideMoreOprationPanel();
					return;
				}
				if (DLNAController.mIsDLNA) {
					// TODO
					Toast.makeText(getContext(), R.string.cannot_switch_player,
	...
	private void getContainer() {
		if (mContainerID != -1) {
			mContainer = (VDVideoControlContainer) ((Activity) mContext)
		...
		if (mContainer == null) {
			...
			if (mContainer != null) {
				...
				mDialog = new AlertDialog.Builder(mContext)
						.setTitle(VDVideoConfig.mDecodingPlayerTitle)
						.setAdapter(new VDVideoDecodingDialogAdapter(), null)
						.setNegativeButton(VDVideoConfig.mDecodingCancelButton,
								new DialogInterface.OnClickListener() {
									...
									public void onClick(DialogInterface dialog,
										...
										// TODO Auto-generated method stub
										VDVideoViewController controller = VDVideoViewController
												.getInstance(VDVideoDecodingButton.this
														.getContext());
										if (null != controller) {
											controller.resume();
											controller.start();
