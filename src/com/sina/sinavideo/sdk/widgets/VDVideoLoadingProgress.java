 ...
 * 
 */
public class VDVideoLoadingProgress extends ProgressBar implements VDBaseWidget, OnLoadingListener {
    ...
    public VDVideoLoadingProgress(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void registerListeners() {
        ...
        if(controller!=null)controller.addOnLoadingListener(this);
    }
