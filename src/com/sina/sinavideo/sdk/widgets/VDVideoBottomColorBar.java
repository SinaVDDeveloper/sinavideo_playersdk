 ...
 *
 */
public class VDVideoBottomColorBar extends SeekBar
        implements
            VDBaseWidget,
    ...
    @Override
    public void hide() {
    	VDVideoViewController ctr = VDVideoViewController.getInstance(this.getContext());
        if(ctr!=null)ctr.removeOnProgressUpdateListener(this);
    }
