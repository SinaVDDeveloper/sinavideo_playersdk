...
public class VDVideoSoundSeekPercentView extends TextView implements VDBaseWidget, OnSoundChangedListener {
    ...
    public VDVideoSoundSeekPercentView(Context context, AttributeSet attrs) {
        ...
        mContext = context;
        TypedArray typedArr = context.obtainStyledAttributes(attrs, new int[]{android.R.attr.textSize,
    ...
    public void reset() {
        ...
        float currPercent = ((float) VDPlayerSoundManager.getCurrSoundVolume(mContext) / VDPlayerSoundManager
    ...
    public void hide() {
        // TODO Auto-generated method stub
    	VDVideoViewController controller = VDVideoViewController.getInstance(this.getContext());
    	if(controller!=null)controller.removeOnSoundChangedListener(this);
    }
    ...
    public void onSoundChanged(int currVolume) {
        ...
        if (DLNAController.mIsDLNA) {
        	VDVideoViewController controller = VDVideoViewController.getInstance(this.getContext());
            if(controller!=null)
            	maxVolume = DLNAController.getInstance(controller.getContext()).getVolumeMax();
        } else {
