...
public class VDVideoLightingPercentView extends TextView implements VDBaseWidget, OnLightingChangeListener {
    ...
    public void hide() {
        // TODO Auto-generated method stub
    	VDVideoViewController controller = VDVideoViewController.getInstance(this.getContext());
    	if(controller!=null)controller.removeOnLightingChangeListener(this);
    }
